...
function dotColor(moisture, careProfile) {
  ...
  if (!range || range[0] == null) return 'var(--chart-moisture-dot-default)'
  const [lo, hi] = range
        ...
        <svg width={svgWidth} height={SVG_H} className={styles.svg}>
          ...
          {isFloodAndDry && thresholdY != null && (
            <line x1={PAD_X} y1={thresholdY} x2={svgWidth - PAD_X} y2={thresholdY}
              stroke="var(--chart-water-line)" strokeWidth="1" strokeDasharray="4,3"/>
          )}
          ...
          {!isFloodAndDry && rangeY1 != null && (
            <>
              <rect
                ...
                fill="var(--chart-ideal-fill)"
              />
              <line x1={PAD_X} y1={rangeY1} x2={svgWidth - PAD_X} y2={rangeY1}
                stroke="var(--chart-ideal-line)" strokeWidth="0.75" strokeDasharray="4,3"/>
          ...
          <polyline
            points={polyPoints}
            fill="none"
            stroke="var(--chart-moisture-line)"
            strokeWidth="1.5"
            ...
            return (
              <g key="est">
                ...
                <line
                  ...
                  stroke="var(--chart-moisture-line-faint)"
                  strokeWidth="1.5"
                  strokeDasharray="3,3"
                  strokeLinecap="round"
                />
                ...
                <circle
                  cx={estX} cy={estY}
                  r={isHovered ? 5.5 : 4}
                  fill="var(--chart-estimated-hollow)"
                  stroke={estColor}
                  strokeWidth="1.5"
                  strokeDasharray="3,2"
                  opacity="0.9"
            ...
            return (
              ...
              >
                <line
                  x1={x} y1={PLOT_TOP - 4}
                  x2={x} y2={PLOT_BOT}
                  stroke="var(--chart-moisture-line-muted)"
                  strokeWidth="0.75"
                  strokeDasharray="2,2"
                />
                <text
                  ...
                  fontSize="8.5"
                  fontFamily="Inter, sans-serif"
                  fill="var(--chart-moisture-dot-default)"
                >💧{label}</text>
          ...
          {[0, 5, 10].map(v => (
            <text
              ...
              fontSize="8"
              fontFamily="Inter, sans-serif"
              fill="var(--chart-axis-label-faint)"
            >{v}</text>
          ))}
